...
namespace MTPS.Movement.Core.StateMachine.Editor.VS
{
    ...
    public class MovementStateMachineVariables_VS : Variables,IMoveStateMachineVariables
    {
        ...
        public RaycastHit GroundHit   { get => declarations.Get<RaycastHit>(nameof(GroundHit));         set => declarations.Set(nameof(GroundHit),value); }
